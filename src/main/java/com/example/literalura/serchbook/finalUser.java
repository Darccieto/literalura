package com.example.literalura.serchbook;
...
import com.literalura.mapper.ConvierteDatos;
import com.literalura.model.Respuesta;
import com.literalura.repository.AutorRepository;
import com.literalura.repository.LibroRepository;
import com.literalura.service.EmpleoAPI;
        
public class finalUser {
    private final String URL_BASE = "https//gutendex.com/books/?search=";
    private Scanner entrada = new Scanner (System.in);
    private EmpleoAPI usoAPI = new EmpleoAPI();
    private CambiaDatos cambia = new CambiaDatos ();
    
    private LibroRepository libroRepositorio;
    private AutorRepository autorRepositorio;

    public finalUser(LibroRepository libroRepositorio, AutorRepository autorRepositorio) {
    ...
    private void buscarLibros() {
        ...
        List<BookEntity> libros = libroRepositorio.findAll();
    ...
    private void buscarPorIdiomas() {
        ...
        List<BookEntity> libros = libroRepositorio.findForLanguaje(seleccion);
